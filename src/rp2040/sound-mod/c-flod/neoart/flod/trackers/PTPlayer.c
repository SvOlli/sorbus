...
void PTPlayer_ctor(struct PTPlayer* self, struct Amiga *amiga) {
	...
	//vtable
	self->super.super.set_force = (void (*)(struct CorePlayer *, int))PTPlayer_set_force;
	self->super.super.process = (void (*)(struct CorePlayer *))PTPlayer_process;
	self->super.super.loader = (void (*)(struct CorePlayer *, struct ByteArray *))PTPlayer_loader;
	self->super.super.initialize = (void (*)(struct CorePlayer *))PTPlayer_initialize;
