...
const uint16_t pal_veto[256] = {
   0x000, 0xfff, 0x833, 0x7cc, 0x839, 0x5a4, 0x229, 0xef7,
   0x852, 0x530, 0xc67, 0x444, 0x777, 0xaf9, 0x76e, 0xbbb,
   0x404, 0xaaa, 0xf55, 0x5ff, 0xf5f, 0x5f5, 0x55f, 0xff5,
   0xf80, 0xff8, 0xf88, 0xf8f, 0x8ff, 0x8f0, 0x2af, 0x88f,
   0x404, 0x404, 0xa00, 0x0aa, 0xa0a, 0x0a0, 0x00a, 0xa50,
   0x888, 0x880, 0x800, 0x808, 0x088, 0x080, 0x125, 0x80f,
   0xffe, 0xa53, 0xfca, 0xccc, 0xf7a, 0x0e3, 0x08f, 0xfe2,
   0xf08, 0xff0, 0xf00, 0xf0f, 0x0ff, 0x0f0, 0x00f, 0x8f8,
   0x404, 0x544, 0xf04, 0x879, 0x725, 0x085, 0x008, 0xfa0,
   0xddd, 0xdd0, 0xd00, 0xd0d, 0x0dd, 0x0d0, 0x00d, 0x0f8,
   0x111, 0x222, 0x444, 0x666, 0x888, 0xaaa, 0xccc, 0xeee,
   0xddd, 0xbbb, 0x999, 0x777, 0x555, 0x333, 0x222, 0x111,
   0x200, 0x411, 0x722, 0x844, 0xb66, 0xd99, 0xebb, 0xfee,
   0xfcc, 0xf99, 0xd66, 0xb44, 0x822, 0x511, 0x300, 0x200,
   0x210, 0x321, 0x532, 0x753, 0x975, 0xb98, 0xdca, 0xfed,
   0xfdb, 0xea6, 0xc73, 0x963, 0x642, 0x421, 0x310, 0x110,
   0x210, 0x320, 0x441, 0x653, 0x885, 0xaa7, 0xcc9, 0xfed,
   0xed8, 0xcb2, 0xa91, 0x763, 0x443, 0x331, 0x220, 0x110,
   0x110, 0x220, 0x341, 0x563, 0x784, 0x9a7, 0xbc9, 0xefd,
   0xce8, 0x9c2, 0x894, 0x572, 0x442, 0x231, 0x120, 0x110,
   0x020, 0x030, 0x141, 0x363, 0x585, 0x7b7, 0xada, 0xdfd,
   0xafa, 0x5d5, 0x5a5, 0x373, 0x353, 0x141, 0x020, 0x010,
   0x011, 0x032, 0x143, 0x365, 0x587, 0x7a9, 0xadc, 0xdfe,
   0x9ed, 0x5ca, 0x598, 0x376, 0x354, 0x132, 0x021, 0x011,
   0x012, 0x123, 0x245, 0x357, 0x589, 0x7ab, 0xacd, 0xdef,
   0xaef, 0x8bd, 0x59a, 0x368, 0x345, 0x134, 0x023, 0x011,
   0x003, 0x215, 0x338, 0x449, 0x66b, 0x99d, 0xbbf, 0xeef,
   0xddf, 0xaaf, 0x77d, 0x55b, 0x339, 0x227, 0x114, 0x002,
   0x202, 0x314, 0x526, 0x648, 0x96a, 0xb8c, 0xdbe, 0xfef,
   0xecf, 0xd8f, 0xa6c, 0x84a, 0x627, 0x415, 0x203, 0x102,
   0x201, 0x413, 0x625, 0x846, 0xa69, 0xc8b, 0xebd, 0xfef,
   0xfce, 0xe8c, 0xc6a, 0x937, 0x725, 0x514, 0x302, 0x101
};
...
static inline void setcolormap( uint8_t data )
{
   ...
   switch( tab )
   {
      ...
      case 7: // Atari 800 colormap, SvOlli style
         ...
         break;
      case 8: // veto colors
         setpalette( &pal_veto[0], count_of(pal_veto) );
         break;
      case 9: // coder colors, VDC inspired
         {
            uint8_t c, r, g, b;
            for( c = 0; c < 0x80; ++c )
            {
