...
void FCPlayer_ctor(struct FCPlayer* self, struct Amiga *amiga) {
	...
	//add vtable
	self->super.super.process = (void (*)(struct CorePlayer *))FCPlayer_process;
	self->super.super.loader = (void (*)(struct CorePlayer *, struct ByteArray *))FCPlayer_loader;
	self->super.super.initialize = (void (*)(struct CorePlayer *))FCPlayer_initialize;
